...
class PersonGenerator(BaseGenerator):
    ...
    def first_name(self, min_length=None, max_length=None):
    ...
    def user_id(self, length=6, only_digits=True):
    ...
    def age(self, min_age=18, max_age=80, boundary=None):
    ...
    def birth_year(self, min_year=1950, max_year=2008, boundary=None):
    ...
    def city(self, starts_with=None):
    ...
    def score(self, min_score=1, max_score=100, boundary=None):
    ...
    def last_name(self, min_length=None, max_length=None):
    ...
    def full_name(self, max_total_length=None):
