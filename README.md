...
## Для чего нужны тестовые данные

Тестовые данные можно использовать, чтобы заполнять формы в web-приложениях с помощью автотестов и ботов, и проверять, как выглядят реалистичные пользовательские данные в готовых документах.

Примеры форм находятся в папке [`forms/`](forms/).

Пример формы:

![Пример формы для заполнения тестовыми данными](forms/form1.png)
